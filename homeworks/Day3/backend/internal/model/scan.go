...
func IsValidScanType(t ScanType) bool {
	...
	case ScanTypeAll, ScanTypeSubdomain, ScanTypeDNS, ScanTypeWHOIS, ScanTypeCertTrans,
		ScanTypePort, ScanTypeASN, ScanTypeSSL, ScanTypeIP:
		return true
	}
	return false
}
...
func (st ScanType) Description() string {
	...
	case ScanTypeIP:
		return "IP Geolocation and ASN lookup via public API (passive)"
	case ScanTypePort:
...
// ============================================================================
// IP Scan Result Models (NEW - Bài 1 Day 3)
// ============================================================================

// IPGeolocation contains geolocation information for an IP address
...
// IPASN contains ASN information for an IP address
type IPASN struct {
...
// IPScanResult represents the full result of an IP geolocation scan
type IPScanResult struct {
	ID         string        `json:"id"`
	AssetID    string        `json:"asset_id"`
	ScanJobID  string        `json:"scan_job_id"`
	IPAddress  string        `json:"ip_address"`
	GeoLocation IPGeolocation `json:"geolocation"`
	ASN        IPASN         `json:"asn"`
...
// ============================================================================
// Port Scan Result Models (NEW - Bài 1 Day 3)
// ============================================================================

// OpenPort contains information about a single open port
...
// PortScanResult represents the full result of a port scan
